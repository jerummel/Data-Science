...
def main():
	...
	try:
		...
		condGenderDataFrameY1 = getDataFrame(condGenderDataY1, "Gender", True, True)
		plotFigure(condGenderDataFrameY1, True, "barh", "Percentage In Each Gender Per Condition In Year 1", "Number of People", "Condition", True, True, (14, 20), 0, 3, "Plots/condGenderCountY1.png")
		querydb(con, viewCreate4)
		condGenderDataY2 = querydb(con, condGenderQueryY2)
		condGenderDataFrameY2 = getDataFrame(condGenderDataY2, "Gender", True, True)
		plotFigure(condGenderDataFrameY2, True, "barh", "Percentage In Each Gender Per Condition In Year 2", "Number of People", "Condition", True, True, (14, 20), 0, 3, "Plots/condGenderCountY2.png")
